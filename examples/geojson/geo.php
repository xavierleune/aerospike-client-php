...
$loc2 = new \Aerospike\GeoJSON\GeoJSON();
echo "var_dump(loc2).\n";
var_dump($loc2);
...
echo "\n\n jsonserialize.\n";
//echo json_encode(new \Aerospike\GeoJSON\GeoJSON($geo_obj));
var_dump($loc->jsonSerialize());
echo "\n\n var_dump(toarray())\n.";
var_dump($loc->toArray());

$rect = \Aerospike\GeoJSON\GeoJSON::fromArray([
    "type" => "Polygon",
    "coordinates" => [[
        [28.60000, -80.590000],
        [28.61800, -80.590000],
...
$json_rect = \Aerospike\GeoJSON\GeoJSON::fromJson($json);
echo "\n\n var_dump(react_json).\n";
var_dump($json_rect);
?>
