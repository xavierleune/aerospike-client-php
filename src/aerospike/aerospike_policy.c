 ...
 * @param admin_policy_p                The admin policy to be passed in case of security operations.
                               ...
                               uint8_t *options_passed_for_remove_p)
{
    ...
    if (ini_value) {
        ...
        if (admin_policy_p) {
            admin_policy_p->timeout = ini_value;
        }
    }
              ...
              as_error *error_p TSRMLS_DC)
{
    ...
    if (options_p == NULL) {
        check_and_set_default_policies(as_config_p, read_policy_p,
                       ...
                       admin_policy_p, NULL, NULL, NULL, NULL);
    } else {
            ...
            switch((int) options_index) {
                ...
                case OPT_SCAN_PRIORITY:
                    ...
                    if (!as_scan_set_priority(as_scan_p, (uint32_t) Z_LVAL_PP(options_value))) {
                        ...
                        PHP_EXT_SET_AS_ERR(error_p, AEROSPIKE_ERR_CLIENT, "Unable to set scan priority");
                        goto exit;
                    }
                    break;
                case OPT_SCAN_PERCENTAGE:
                    ...
                    if (scan_percentage < 0 || scan_percentage > 100) {
                        ...
                        PHP_EXT_SET_AS_ERR(error_p, AEROSPIKE_ERR_CLIENT, "Invalid value for scan percent");
                        goto exit;
                    } else if (!as_scan_set_percent(as_scan_p, scan_percentage)) {
                        DEBUG_PHP_EXT_DEBUG("Unable to set scan percent");
                        PHP_EXT_SET_AS_ERR(error_p, AEROSPIKE_ERR_CLIENT, "Unable to set scan percent");
                        goto exit;
                    }
                    break;
                case OPT_SCAN_CONCURRENTLY:
                    ...
                    if (!as_scan_set_concurrent(as_scan_p, (uint32_t) Z_BVAL_PP(options_value))) {
                        ...
                        PHP_EXT_SET_AS_ERR(error_p, AEROSPIKE_ERR_CLIENT, "Unable to set scan concurrency");
                        goto exit;
                    }
                    break;
                case OPT_SCAN_NOBINS:
                    ...
                    if (!as_scan_set_nobins(as_scan_p, (uint32_t) Z_BVAL_PP(options_value))) {
                        ...
                        PHP_EXT_SET_AS_ERR(error_p, AEROSPIKE_ERR_CLIENT, "Unable to set scan no bins");
                        goto exit;
                    }
                    break;
                case OPT_POLICY_KEY:
        ...
        if (write_policy_p) {
            check_and_set_default_policies((connect_flag ? NULL : as_config_p),
                    ...
                    NULL, NULL, NULL, &options_passed_for_write, NULL, NULL,
                    NULL);
            connect_flag = 1;
        }
        if (read_policy_p) {
            check_and_set_default_policies((connect_flag ? NULL : as_config_p),
                    ...
                    NULL, NULL, NULL, NULL, &options_passed_for_read, NULL, NULL);
            connect_flag = 1;
        }
        if (operate_policy_p) {
            check_and_set_default_policies(NULL, NULL, NULL, operate_policy_p,
                    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    &options_passed_for_operate, NULL);
        }
        if (remove_policy_p) {
            check_and_set_default_policies(NULL, NULL, NULL, NULL,
                    remove_policy_p, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 ...
 */
extern void
set_policy_query(as_policy_query *query_policy_p,
        zval *options_p,
        as_error *error_p TSRMLS_DC)
{
    set_policy_ex(NULL, NULL, NULL, NULL, NULL, NULL, NULL,
            query_policy_p, NULL, NULL, NULL, NULL, NULL, options_p,
            error_p TSRMLS_CC);
}
        ...
        as_error *error_p TSRMLS_DC)
{
    set_policy_ex(NULL, NULL, NULL, NULL, NULL, NULL, scan_policy_p, NULL,
            serializer_policy_p, as_scan_p, NULL, NULL, NULL, options_p,
            error_p TSRMLS_CC);
}
        ...
        as_error *error_p TSRMLS_DC)
{
    set_policy_ex(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
            NULL, NULL, batch_policy_p, NULL, NULL, options_p,
            error_p TSRMLS_CC);
}
...
{
    set_policy_ex(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
            NULL, NULL, NULL, apply_policy_p, NULL, options_p,
            error_p TSRMLS_CC);
}
                     ...
                     as_error *error_p TSRMLS_DC)
{
    ...
    set_policy_ex(as_config_p, &as_config_p->policies.read,
            &as_config_p->policies.write, NULL, NULL, NULL, NULL, NULL, NULL,
