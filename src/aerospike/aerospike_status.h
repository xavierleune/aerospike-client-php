...
AerospikeStatus aerospike_status[] = {
  ...
  { AEROSPIKE_SECURITY_NOT_SUPPORTED        ,   "SECURITY_NOT_SUPPORTED"          },
  { AEROSPIKE_SECURITY_NOT_ENABLED          ,   "SECURITY_NOT_ENABLED"            },
  { AEROSPIKE_SECURITY_SCHEME_NOT_SUPPORTED ,   "SECURITY_SCHEME_NOT_SUPPORTED"   },
  { AEROSPIKE_INVALID_USER                  ,   "INVALID_USER"                    },
  { AEROSPIKE_USER_ALREADY_EXISTS           ,   "USER_ALREADY_EXISTS"             },
  { AEROSPIKE_INVALID_PASSWORD              ,   "INVALID_PASSWORD"                },
  { AEROSPIKE_EXPIRED_PASSWORD              ,   "EXPIRED_PASSWORD"                },
  { AEROSPIKE_FORBIDDEN_PASSWORD            ,   "FORBIDDEN_PASSWORD"              },
  { AEROSPIKE_INVALID_CREDENTIAL            ,   "INVALID_CREDENTIAL"              },
  { AEROSPIKE_INVALID_ROLE                  ,   "INVALID_ROLE"                    },
  { AEROSPIKE_INVALID_PRIVILEGE             ,   "INVALID_PRIVILEGE"               },
  { AEROSPIKE_NOT_AUTHENTICATED             ,   "NOT_AUTHENTICATED"               },
  { AEROSPIKE_ROLE_VIOLATION                ,   "ROLE_VIOLATION"                  }
};
