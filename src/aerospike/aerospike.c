...
PHP_INI_BEGIN()
   ...
   STD_PHP_INI_ENTRY("aerospike.udf.lua_system_path", "", PHP_INI_PERDIR|PHP_INI_SYSTEM, OnUpdateString, lua_system_path, zend_aerospike_globals, aerospike_globals)
   STD_PHP_INI_ENTRY("aerospike.udf.lua_user_path", "", PHP_INI_PERDIR|PHP_INI_SYSTEM, OnUpdateString, lua_user_path, zend_aerospike_globals, aerospike_globals)
PHP_INI_END()
