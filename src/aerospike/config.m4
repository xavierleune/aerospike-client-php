...
if test "$PHP_AEROSPIKE" = "yes"; then
  ...
  PHP_NEW_EXTENSION(aerospike, aerospike.c aerospike_policy.c aerospike_transform.c aerospike_helper.c aerospike_record_operations.c aerospike_udf.c aerospike_scan.c, $ext_shared)
fi
